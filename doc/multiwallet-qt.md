...
In order to support loading of multiple wallets in bitesax-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitesax.cpp.
...
Changes to bitesax.cpp
----------------------
bitesax.cpp is the entry point into bitesax-qt, and as such, will require some minor modifications to provide hooks for
