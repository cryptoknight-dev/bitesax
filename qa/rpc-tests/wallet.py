...
#   c) node1 mines 32 blocks, so now node 0 has 500000BTEX, node 1 has 4250BTEX, node2 has none.
#   d) node0 sends 601 BTEX to node2, in two transactions (301 BTEX, then 300 BTEX).
