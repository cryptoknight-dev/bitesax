...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitesax Core bitesax-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitesax-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitesax transaction") + "\n" +
                               "  bitesax-tx [options] -create [commands]   " + _("Create hex-encoded bitesax transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitesax transaction
