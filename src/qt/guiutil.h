...
/** Utility functions used by the Bitesax Qt UI.
 */
namespace GUIUtil
{
...
// Render BTEX addresses in monospace font
...
// Parse "bitesax:" URI into recipient object, return true on successful parsing
