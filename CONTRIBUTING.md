Contributing to Bitesax Core
==================================

The Bitesax Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bitesax Core project, and is not to be
confused with overall Bitesax Network Protocol consensus changes.

Whether a pull request is merged into Bitesax Core rests with the project merge
...
Patches that change Bitesax consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitesax consensus, it must have been
...
The project leader is the release manager for each Bitesax Core release.
