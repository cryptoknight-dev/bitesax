...
RESOURCES += src/qt/bitesax.qrc src/qt/bitesax_locale.qrc

TRANSLATIONS += src/qt/locale/bitesax_bg.ts \
                src/qt/locale/bitesax_de.ts \
                src/qt/locale/bitesax_en.ts \
                src/qt/locale/bitesax_es.ts \
                src/qt/locale/bitesax_fi.ts \
                src/qt/locale/bitesax_fr.ts \
                src/qt/locale/bitesax_it.ts \
                src/qt/locale/bitesax_ja.ts \
                src/qt/locale/bitesax_pl.ts \
                src/qt/locale/bitesax_pt.ts \
                src/qt/locale/bitesax_ru.ts \
                src/qt/locale/bitesax_sk.ts \
                src/qt/locale/bitesax_sv.ts \
                src/qt/locale/bitesax_vi.ts \
                src/qt/locale/bitesax_zh_CN.ts \
                src/qt/locale/bitesax_zh_TW.ts
