...
This mechanism has been integrated into Bitcore-Node-Bitesax which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitesax/insight-api-bitesax#web-socket-api](https://github.com/bitesax/insight-api-bitesax#web-socket-api)
* API: [https://github.com/bitesax/insight-api-bitesax#swifttx-transactions](https://github.com/bitesax/insight-api-bitesax#swifttx-transactions)
...
By default, the Bitesax Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bitesax Core daemon:
