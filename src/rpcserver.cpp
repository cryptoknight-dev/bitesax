...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Bitesax server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bitesax features */
        {"bitesax", "masternode", &masternode, true, true, false},
        {"bitesax", "listmasternodes", &listmasternodes, true, true, false},
        {"bitesax", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitesax", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitesax", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitesax", "masternodedebug", &masternodedebug, true, true, false},
        {"bitesax", "startmasternode", &startmasternode, true, true, false},
        {"bitesax", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitesax", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitesax", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitesax", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitesax", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitesax", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitesax", "mnbudget", &mnbudget, true, true, false},
        {"bitesax", "preparebudget", &preparebudget, true, true, false},
        {"bitesax", "submitbudget", &submitbudget, true, true, false},
        {"bitesax", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitesax", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitesax", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitesax", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitesax", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitesax", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitesax", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitesax", "checkbudgets", &checkbudgets, true, true, false},
        {"bitesax", "mnsync", &mnsync, true, true, false},
        {"bitesax", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> bitesax-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9634/\n";
}
