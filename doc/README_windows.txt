...
Intro
-----
Bitesax (BTEX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Bitesax utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run bitesax-qt.exe.

Bitesax Core is the original Bitesax client and it builds the backbone of the network.
However, it downloads and stores the entire history of Bitesax transactions;
